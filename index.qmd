...
::: {.center-v}
![](images/cryptogams.jpg){height="600"}
:::
...
::: {.center-v}
![](images/lifecycle.jpeg){height="600"}
:::
...
## Field biology in the age of data science

::: {.center-v}
![](images/field_biology_data_science_cycle.png){height="550"}
:::

## Field biology in the age of ~~data~~ citizen science

::: {.center-v}
![](images/field_biology_citizen_science_cycle.png){height="550"}
:::

---

::: {.center-v}
![](images/inat-blechnum.jpg){height="450"}
:::

---

::: {.center-v}
![](images/inat-blechnum-license.jpg){height="450"}
:::

## Making data **open**

- Data should have a license
- Data should be well-documented 
- Data should be findable (in a public database)
